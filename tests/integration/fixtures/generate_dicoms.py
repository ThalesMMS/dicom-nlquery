...
SYNTHETIC_STUDIES: list[SyntheticStudy] = [
    SyntheticStudy(
        ...
        series_description="AX T1 CRANIAL",
        modality="MR",
        study_description="MR cranial study",
    ),
    SyntheticStudy(
        patient_sex="F",
        ...
        series_description="SAG T2 CRANIAL",
        modality="MR",
        study_description="MR cranial study",
    ),
    SyntheticStudy(
        ...
        series_description="AX T1 THORAX",
        modality="CT",
        study_description="CT thorax study",
    ),
    SyntheticStudy(
        patient_sex="F",
        ...
        series_description="AX CRANIAL",
        modality="CT",
        study_description="CT cranial study",
    ),
    SyntheticStudy(
        patient_sex="F",
        ...
        series_description="CRANIAL MT POS",
        modality="MR",
        study_description="MR cranial study",
    ),
    SyntheticStudy(
